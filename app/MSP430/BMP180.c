...
static void writeCommand(byte reg, byte value)
{
	...
	temp[0] = value;
	  msp430_i2c_pressurewrite(BMP085_ADDRESS, reg, 1, temp);
}
...
{
	msp430_i2c_read(BMP085_ADDRESS, reg, 1, value);
}
...
static void read16(byte reg, uint16_t *value)
{
	...
	msp430_i2c_read(BMP085_ADDRESS, reg, 2, temp);
...
static void readCoefficients(void)
{
    ...
    printf("ac1 %d, %d, %d, %d\n",_bmp085_coeffs.ac1, _bmp085_coeffs.ac2, _bmp085_coeffs.ac3, _bmp085_coeffs.ac4);
    printf("ac1 %d, %d, %d, %d\n",_bmp085_coeffs.ac5, _bmp085_coeffs.ac6, _bmp085_coeffs.b1, _bmp085_coeffs.b2);
    printf("ac1 %d, %d, %d\n",_bmp085_coeffs.mb, _bmp085_coeffs.mc, _bmp085_coeffs.md);
}
